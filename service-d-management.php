...
<head>
    ...
    <title>Staff Management || Services Details || Hiredots || HTML Template For Beauty & Spa</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title">Staff Management</h2>
                    ...
                    <div class="col-md-12 col-lg-8">
                        <div class="service-details__content">
                            <div class="service-details__thumbnail">
                                <img src="assets/images/resources/service-d-6.png" alt="Staff Management">
                            </div><!-- /.service-details__thumbnail -->
                            <h3 class="service-details__title">Staff Management</h3><!-- /.service-details__title -->
