...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="main-slider-two">
            <div class="main-slider-two__carousel hiredots-owl__carousel owl-carousel" data-owl-options='{
		"loop": true,
		...
		"margin": 0
                ...
                <div class="item">
                    <div class="main-slider-two__item">
                        ...
                        <div class="main-slider-two__shape-top" style="background-image: url(assets/images/shapes/slider-2-shape-2.png);"></div>
                        <div class="main-slider-two__shape-bottom" style="background-image: url(assets/images/shapes/slider-2-shape-1.png);"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="main-slider-two__content">
                                        <h5 class="main-slider-two__sub-title">Reliable Recruitment Agency</h5><!-- slider-sub-title -->
                                        <h2 class="main-slider-two__title">Provide Human<br> Partner Solution</h2><!-- slider-title -->
        ...
        <section class="about-two">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="about-two__image wow fadeInLeft" data-wow-delay="300ms">
                            <div class="about-two__image-one">
                                <img src="assets/images/resources/about-2-1.jpg" alt="hiredots">
                            </div>
                            <div class="about-two__image-two">
                                <img src="assets/images/resources/about-2-2.jpg" alt="hiredots">
                                <div class="about-two__image-icon"><img src="assets/images/resources/about-1-bulb.png" alt="hiredots"></div>
                            </div>
                            <img class="about-two__image__shape" src="assets/images/resources/about-1-shape-1.png" alt="hiredots">
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="300ms">
                        <div class="about-two__content">
                            <div class="sec-title text-left">
                                ...
                                <h3 class="sec-title__title">Ready to Hire your Next Candidate</h3><!-- /.sec-title__title -->
                            </div><!-- /.sec-title -->
                            <p class="about-two__content__text">
                                ...
                                Sed risus augue, commodo ornare felis non.
                            </p>
                            <div class="about-two__content__info">
                                <ul class="about-two__content__list">
                                    <li><span class="fa fa-check-circle"></span>Hiring Employeers</li>
                                    <li><span class="fa fa-check-circle"></span>Cost Efficiant</li>
                                    <li><span class="fa fa-check-circle"></span>Outsourced Consulting</li>
                                    <li><span class="fa fa-check-circle"></span>Leadership Training</li>
                                </ul>
                                <div class="clearfix"></div>
                                <h5 class="about-two__content__title"><span class="icon-creative-idea"></span>Welcome to Professional Recruitment Agency</h5>
                            </div>
                            <div class="about-two__content__author-wrapper">
                                ...
                                <a href="about.html" class="hiredots-btn hiredots-btn--base"><span>Discover more</span></a>
                            </div>
                        </div>
                    </div><!-- /.col-lg-4 -->
                </div><!-- /.row -->
        ...
        <section class="cta-foue">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <h2 class="cta-foue__title">Hire Your Next Candidate on Hiredots</h2><!-- /.cta-foue__title -->
                    </div>
                    <div class="col-md-4 text-end">
                        <a href="about.html" class="hiredots-btn"><span>Discover More</span></a>
                    </div>
                </div>
            </div><!-- /.container -->
        </section><!-- /.cta-three -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="sec-title text-center">
                            ...
                            <h6 class="sec-title__tagline">our easy steps</h6><!-- /.sec-title__tagline -->

                            <h3 class="sec-title__title">See Our Simply Plan & <br>Working Style</h3><!-- /.sec-title__title -->
                        </div><!-- /.sec-title -->
                        <!-- section-title -->
                    </div>
                </div>
                <div class="row gutter-y-30">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="work-process-one__item text-center">
                            <div class="work-process-one__item__shape" style="background-image: url(assets/images/shapes/work-process-shape.png);"></div>
                            <div class="work-process-one__item__icon-bg"></div>
                            ...
                            <div class="work-process-one__item__content">
                                <h4 class="work-process-one__item__title">Consult with Team</h4><!-- /.work-process-title -->
                                <p class="work-process-one__item__text">
                                    Lorem Ipsum is simply dummy text of the<br> new des printng and masn is type.
                                </p><!-- /.work-process-text -->
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="work-process-one__item text-center">
                            <div class="work-process-one__item__shape work-process-one__item__shape--md-none" style="background-image: url(assets/images/shapes/work-process-shape.png);"></div>
                            <div class="work-process-one__item__icon-bg"></div>
                            <div class="work-process-one__item__icon">
                                <span class="icon-checklist"></span>
                            </div><!-- /.work-process-icon -->
                            <div class="work-process-one__item__content">
                                <h4 class="work-process-one__item__title">Make a Schedule</h4><!-- /.work-process-title -->
                                <p class="work-process-one__item__text">
                                    Lorem Ipsum is simply dummy text of the<br> new des printng and masn is type.
                                </p><!-- /.work-process-text -->
                                <div class="work-process-one__item__number"></div><!-- /.work-process-number -->
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="work-process-one__item text-center">
                            ...
                            <div class="work-process-one__item__content">
                                <h4 class="work-process-one__item__title">Hire & Enjoy</h4><!-- /.work-process-title -->
                                <p class="work-process-one__item__text">
                                    Lorem Ipsum is simply dummy text of the<br> new des printng and masn is type.
                                </p><!-- /.work-process-text -->
                                <div class="work-process-one__item__number"></div><!-- /.work-process-number -->
        ...
        <!-- Work Process End -->
        <div class="project-two" style="background-image: url(assets/images/backgrounds/project-bg-1.jpg);">
            <div class="container">
                <div class="row tabs-box">
                    <div class="col-lg-4">
                        <div class="project-two__left-content">
                            <div class="sec-title text-left">
                            ...
                            <ul class="list-unstyled tab-buttons project-two__list">
                                <li data-tab="#staffing_solution" class="tab-btn active-btn">Staffing Solution</li>
                                <li data-tab="#scale_up_business" class="tab-btn">Scale-Up Business</li>
                                <li data-tab="#resume_management" class="tab-btn">Resume Management</li>
                                <li data-tab="#employee_on_boarding" class="tab-btn">Employee On-Boarding</li>
                                <li data-tab="#application_screening" class="tab-btn">Application Screening</li>
                            </ul><!-- /.list-unstyledf -->
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="hiredots-stretch-element-inside-column">
                            <div class="tabs-content">
                                <div class="tab active-tab fadeInUp animated" id="staffing_solution">
                                    <div class="project-two__card">
                                        <div class="project-two__img">
                                            <img src="assets/images/project/project-2-1.jpg" alt="hiredots">
                                        </div>
                                        <div class="project-two__btn">
                                            <a href="project-details.html" class="hiredots-btn"><span class="icon-right-arrow"></span></a>
                                        </div>
                                        <div class="project-two__content">
                                            <span class="project-two__tagline">Resources</span>
                                            <h3 class="project-two__title"><a href="project-details.html">Staffing Solution</a></h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab fadeInUp animated" id="scale_up_business">
                                    <div class="project-two__card">
                                        <div class="project-two__img">
                                            <img src="assets/images/project/project-2-2.jpg" alt="hiredots">
                                        </div>
                                        <div class="project-two__btn">
                                            <a href="project-details.html" class="hiredots-btn"><span class="icon-right-arrow"></span></a>
                                        </div>
                                        <div class="project-two__content">
                                            <span class="project-two__tagline">Resources</span>
                                            <h3 class="project-two__title"><a href="project-details.html">Scale-Up Business</a></h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab fadeInUp animated" id="resume_management">
                                    <div class="project-two__card">
                                        <div class="project-two__img">
                                            <img src="assets/images/project/project-2-1.jpg" alt="hiredots">
                                        </div>
                                        ...
                                        <div class="project-two__content">
                                            <span class="project-two__tagline">Resources</span>
                                            <h3 class="project-two__title"><a href="project-details.html">Resume Management</a></h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab fadeInUp animated" id="employee_on_boarding">
                                    <div class="project-two__card">
                                        <div class="project-two__img">
                                            <img src="assets/images/project/project-2-2.jpg" alt="hiredots">
                                        </div>
                                        ...
                                        <div class="project-two__content">
                                            <span class="project-two__tagline">Resources</span>
                                            <h3 class="project-two__title"><a href="project-details.html">Employee On-Boarding</a></h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab fadeInUp animated" id="application_screening">
                                    <div class="project-two__card">
                                        <div class="project-two__img">
                                            <img src="assets/images/project/project-2-1.jpg" alt="hiredots">
                                        </div>
                                        ...
                                        <div class="project-two__content">
                                            <span class="project-two__tagline">Resources</span>
                                            <h3 class="project-two__title"><a href="project-details.html">Application Screening</a></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="cta-three cta-three--home">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="testimonials-two__wrapper">
                                ...
                                <div class="testimonials-two__carousel hiredots-slick__carousel" data-slick-options='{
							"slidesToShow": 1,
							"slidesToScroll": 1,
							"asNavFor": ".testimonials-two__image",
							"autoplay": true,
							"dots": false,
							"centerPadding": 0,
							"arrows": false
                                    ...
                                    <div class="item">
                                        <div class="testimonials-two__item">
                                            <div class="testimonials-two__item__author">
                                                <img src="assets/images/resources/testi-2-big.jpg" alt="hiredots">
                                            </div>
                                            ...
                                            <div class="testimonials-two__meta">
                                                <h5 class="testimonials-two__meta__name">Christine Eve</h5><span class="testimonials-two__meta__dot">.</span>Our Customer
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Testimonial Item -->
                                    ...
                                    <div class="item">
                                        <div class="testimonials-two__item">
                                            <div class="testimonials-two__item__author">
                                                <img src="assets/images/resources/testi-3-big.jpg" alt="hiredots">
                                            </div>
                                            <div class="testimonials-two__item__quote">
                                                This is due to their excellent service, competitive pricing and customer support.
                                                It’s throughly refresing to get such a personal touch.
                                            ...
                                            <div class="testimonials-two__meta">
                                                <h5 class="testimonials-two__meta__name">Alesha Brown</h5><span class="testimonials-two__meta__dot">.</span>Developer
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Testimonial Item -->
                                    ...
                                    <div class="item">
                                        <div class="testimonials-two__item">
                                            <div class="testimonials-two__item__author">
                                                <img src="assets/images/resources/testi-4-big.jpg" alt="hiredots">
                                            </div>
                                            <div class="testimonials-two__item__quote">
                                                This is due to their excellent service, competitive pricing and customer support.
                                                It’s throughly refresing to get such a personal touch.
                                    ...
                                    <div class="item">
                                        <div class="testimonials-two__item">
                                            <div class="testimonials-two__item__author">
                                                <img src="assets/images/resources/testi-5-big.jpg" alt="hiredots">
                                            </div>
                                            <div class="testimonials-two__item__quote">
                                                This is due to their excellent service, competitive pricing and customer support.
                                                It’s throughly refresing to get such a personal touch.
                                ...
                                <ul class="testimonials-two__image hiredots-slick__carousel" data-slick-options='{
							"slidesToShow": 3,
							"slidesToScroll": 1,
							"autoplay": true,
							"vertical": true,
							...
							"responsive": [
                                    ...
                                    <li role="presentation">
                                        <div class="testimonials-two__image__item"><img src='assets/images/resources/testi-2-1.jpg' alt='hiredots'></div>
                                    </li>
                                    <!-- Testimonial Item -->
                                    <!-- Testimonial Item -->
                                    <li role="presentation">
                                        <div class="testimonials-two__image__item"><img src='assets/images/resources/testi-2-2.jpg' alt='hiredots'></div>
                                    </li>
                                    <!-- Testimonial Item -->
                                    <!-- Testimonial Item -->
                                    <li role="presentation">
                                        <div class="testimonials-two__image__item"><img src='assets/images/resources/testi-2-3.jpg' alt='hiredots'></div>
                                    </li>
                                    <!-- Testimonial Item -->
                                    <!-- Testimonial Item -->
                                    <li role="presentation">
                                        <div class="testimonials-two__image__item"><img src='assets/images/resources/testi-2-4.jpg' alt='hiredots'></div>
                                    </li>
                                    <!-- Testimonial Item -->
                                </ul>
                        ...
                        <div class="col-lg-4">
                            <div class="funfact-two">
                                <div class="funfact-two__item">
                                    <div class="funfact-two__icon"><span class="icon-business-idea"></span></div><!-- /.funfact-two__icon -->
                                    <div class="funfact-two__count count-box"><span class="count-text" data-stop="697" data-speed="1500"></span></div><!-- /.funfact-two__count -->
                                    <p class="funfact-two__text">Employer Solutions</p><!-- /.funfact-two__text -->
                                </div><!-- /.funfact-two__item -->
                                <div class="funfact-two__item">
                                    <div class="funfact-two__icon"><span class="icon-recruit"></span></div><!-- /.funfact-two__icon -->
                                    <div class="funfact-two__count count-box"><span class="count-text" data-stop="430" data-speed="1500"></span></div><!-- /.funfact-two__count -->
                                    <p class="funfact-two__text">People Job Seekers</p><!-- /.funfact-two__text -->
                                </div><!-- /.funfact-two__item -->
                                <div class="funfact-two__item">
                                    <div class="funfact-two__icon"><span class="icon-customer-review"></span></div><!-- /.funfact-two__icon -->
                                    <div class="funfact-two__count count-box"><span class="count-text" data-stop="800" data-speed="1500"></span></div><!-- /.funfact-two__count -->
                                    <p class="funfact-two__text">Happy Customers</p><!-- /.funfact-two__text -->
                                </div><!-- /.funfact-two__item -->
                            </div>
                        </div>
                    </div>
        ...
        <section class="contact-two">
            <div class="contact-two__bg" style="background-image: url(assets/images/backgrounds/contact-bg-1.jpg);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <form class="contact-two__form contact-form-validated wow fadeInUp" data-wow-duration="1500ms" action="https://thegenius.co/html/hiredots/inc/sendemail.php">
                            <div class="contact-one__form__top">
                                <div class="sec-title text-@@textAlign">
                                    ...
                                    <h3 class="sec-title__title">Write Message</h3><!-- /.sec-title__title -->
                                </div><!-- /.sec-title -->
                            </div><!-- /.contact-one__form__top -->
                            <div class="form-two__group">
                                <div class="form-two__control form-two__control--full">
                                    <input type="text" name="name" placeholder="Your name">
                                </div><!-- /.form-two__control form-two__control--full -->
                                <div class="form-two__control form-two__control--full">
                    ...
                    <div class="col-lg-6">
                        <div class="contact-two__info">
                            ...
                            <h3 class="contact-two__label">Contact us</h3>
                        </div>
                        <div class="contact-two__map hiredots-stretch-element-inside-column">
